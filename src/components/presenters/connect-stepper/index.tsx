      ...
      <ul className="flex flex-col md:flex-row gap-4">
        <li className="flex gap-2 md:flex-col md:flex-1">
          ...
          <div className="flex flex-col gap-2">
            <span className="block font-semibold">Sign in with Google</span>
        ...
        <li className="flex gap-2 md:flex-col md:flex-1">
          <div
            ...
            aria-hidden="true"
          >
            <span className="size-7 flex justify-center items-center shrink-0 bg-zinc-700 border-1 border-lime-400 font-medium text-lime-400 rounded-full">
          ...
          <div className="flex flex-col gap-2">
            <span id="connect-your-calendar" className="block font-semibold">
            ...
            <div className="mt-4">
              <button
                ...
                className="bg-lime-400 hover:bg-lime-300 text-zinc-900 text-sm font-semibold py-2 px-4 rounded-md inline-flex items-center gap-2 cursor-pointer transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-lime-500/20"
              >
                {isConnecting ? (
                  <Loader2Icon
        ...
        <li className="flex gap-2 md:flex-col md:flex-1">
          ...
          <div className="flex flex-col gap-2 text-zinc-500">
            <span className="block font-semibold">See your year</span>
            <p className="text-sm">
